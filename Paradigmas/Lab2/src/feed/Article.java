...
public class Article {
	...
	public void prettyPrint() {
		System.out.println(ANSI_YELLOW + "Title: " + this.getTitle());
		System.out.println(ANSI_WHITE + "Publication Date: " + this.getPublicationDate());
		System.out.println("Link: " + this.getLink());
		System.out.println("Text: " + this.getText());
		System.out.println(ANSI_PURPLE + "**********************************************************************************************" + ANSI_WHITE);
	}
